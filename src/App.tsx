...
function App() {
  const [activeTab, setActiveTab] = useState<'tasks' | 'users' | 'priorities'>('tasks');
            ...
            <div className="max-w-3xl w-full space-y-8 bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8">
              ...
              <div className="flex p-1 bg-black/20 rounded-xl">
                ...
                <button
                  ...
                  className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${
                    activeTab === 'priorities' ? 'bg-white text-indigo-600 shadow-sm' : 'text-white/60 hover:text-white'
                  }`}
                >
                  Priorities
                </button>
